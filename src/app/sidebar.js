...
import { BiChat, BiLineChart, BiTachometer, BiReceipt } from "react-icons/bi";
    ...
    <>
      ...
      >
        <div>
          <Link
            href="/chat"
            className={`flex justify-center items-center w-10 h-10 m-5 rounded-lg ${pathname === "/chat" ? "bg-blue-500" : ""
              }`}
          >
            <BiChat size={22} />
          </Link>
          ...
          <Link
            href="/analytics"
            className={`flex justify-center items-center w-10 h-10 m-5 rounded-lg ${pathname === "/analytics" ? "bg-blue-500" : ""
              }`}
          >
            <BiLineChart size={22} />
          </Link>
          ...
          <Link
            href="/tickets"
            className={`flex justify-center items-center w-10 h-10 m-5 rounded-lg ${pathname === "/tickets" ? "bg-blue-500" : ""
              }`}
            title="Tickets"
          >
            <BiReceipt size={22} />
          ...
          <Link
            href="/quota"
            className={`flex justify-center items-center w-10 h-10 m-5 rounded-lg ${pathname === "/quota" ? "bg-blue-500" : ""
              }`}
          >
      ...
      <nav className="flex md:hidden fixed bottom-0 left-0 w-full bg-slate-900 text-white justify-around items-center h-16 border-t border-slate-700 z-50">
        ...
        <Link href="/tickets" className="flex flex-col items-center">
          <BiReceipt
            size={22}
            className={pathname === "/tickets" ? "text-blue-400" : "text-white"}
          />
          <span className={pathname === "/tickets" ? "text-blue-400 text-xs" : "text-white text-xs"}>
            Tickets
          </span>
        </Link>
